...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- visual grouping wrapper, not a semantic <fieldset>
      role="group"
      className={cn(
...
function InputGroupAddon({
  ...
  return (
    // oxlint-disable-next-line jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- click-to-focus convenience only; the actual <input> stays keyboard-reachable via Tab
    <div
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- visual grouping wrapper, not a semantic <fieldset>
      role="group"
